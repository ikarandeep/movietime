...
var sendText = function(number, msg) {
    ...
    var accountSid = 'AC96d53fd16d9769d80793244ed67e8f79';
    var authToken = '452d60d2cf67208e03113345895ad58d';
                                ...
                                if (users) {
                                    users.forEach(function(user) {
                                        if (user.interests) {
                                            ...
                                            // if user.interests is an array, that means there are multiple generes they like
                                            // continue with this function.
                                            // if not then we need to just do it with one genre.
                                           
                                          if (typeof user.interests == 'string' || user.interests instanceof String)
                                          {
                                          ...
                                          {
                                            var interestsForUser = user.interests;
                                            var moviesRecommendedForUser = [];
                                            ...
                                            if (moviesRecommendedForUser.length > 0) {
                                                var msg = "Watch these movies: " + moviesRecommendedForUser.join(', ');
                                                //var msg = "watch movie";
